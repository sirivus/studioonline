...
class Water2 extends Mesh {
	...
	constructor( geometry, options = {} ) {
		...
		// needed to control which objects are reflected
		const onBeforeRender = typeof options.onBeforeRender === 'function' ? options.onBeforeRender : null;
